...
def test_set_price_feed_contract():
    ...
    account = get_account()
    non_owner = get_account(index=1)  # will use to test onlyOwner functions
...
def test_issue_tokens(amount_staked):
    ...
    # Arrange
    # staking 1 dapp_token, which is equal in price to 1 eth
    # so should get 3000 dapp tokens in reward, since price of eth is 3000usd
